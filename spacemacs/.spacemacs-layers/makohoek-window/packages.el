...
(defun makohoek-window/post-init-window-purpose ()
  (use-package window-purpose
    ...
    (progn
      ...
      ;; to edit popwin:special-display-config, see
      ;; https://github.com/syl20bnr/spacemacs/issues/6649#issuecomment-234490739
      (push '("*compilation*" :dedicated t :position right :stick t :noselect t :width 0.3)
