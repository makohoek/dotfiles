...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-configuration-layer-path '("~/.spacemacs-layers/" "~/.spacemacs-layers-work/")
   ...
   '(;; layers from spacemacs-all
     ...
     (spacemacs-modeline :packages (not anzu fancy-battery symon vim-powerline))
   ...
   dotspacemacs-excluded-packages '(helm-cscope org-mu4e rainbow-delimiters neotree linum-mode tern)
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-mode-line-theme '(doom :separator bar :separator-scale 1)
